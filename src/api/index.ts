...
import type { Product, Category, SubCategory, SubSubCategory, Order, NewsItem, Discount, Arrival, ScheduleDay, OrderStatus } from '@/types'
...
export const ordersApi = {
  create: (data: { tg_username: string; items: { product_id: string; quantity: number }[]; pickup_time: string }) =>
